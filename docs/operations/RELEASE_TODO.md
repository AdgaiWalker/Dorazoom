...
- [x] Xcode 26.6 已安装
- [x] 现有 Swift 自动化测试为 228 项
- [x] `Scripts/release-internal.sh` 已准备为站外完整版发布入口
- [x] 网站发布二进制 `website/public/DoraZoom.zip` 已从仓库移除
- [x] Mac App Store Xcode App target、App Sandbox entitlements 和 Archive scheme
...
- [x] 保持 `ZoomItMacCore` 为两个版本的共享实现
- [x] 新增正式 Xcode macOS App target、Archive scheme、AppIcon asset 和商店版 Info.plist
- [x] 为商店版增加 `com.apple.security.app-sandbox` 及最小必需硬件、文件访问 entitlement
- [x] 将模拟粘贴能力置于发布风味开关后；商店 target 编译时关闭，完整版开启
...
- [x] 锁定首发版本号、Bundle ID、SKU、分类、年龄分级和隐私答案草稿
- [x] 准备 App Store 图标、商店文案、支持和隐私政策链接；截图待从最终签名商店版生成
